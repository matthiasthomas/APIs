	...
	*/
	...
	if (Modernizr.touch) {
		...
		$('[class*="effect-"] figure').on('touchstart', function() {
			...
			/** ---------------------------------------------------------------- **/
			/** Modified By Matthias TL (19/01/2014): To disable hovered while scrolling on the iPhone **/
			/** ---------------------------------------------------------------- **/
			var originalOffset = window.pageYOffset;
			setTimeout(function() {
				if (window.pageYOffset == originalOffset) {
					if (!$('[class*="effect-"] figure').hasClass('hovered')) {
						//$('[class*="effect-"] figure').removeClass('hovered');
						$('[class*="effect-"] figure').addClass('hovered');
			...
			/** ---------------------------------------------------------------- **/
			/** End modification By Matthias TL (19/01/2014) **/
			/** ---------------------------------------------------------------- **/
		});
	} else {
